"""
This is a starter Lambda function for the Check_Ticket_Status intent. Follow the README.md for a guide
...
def lambda_handler(event, context):
    ...
    if record is None:
        response_string = "We were unable to locate support case " + event['currentIntent']['slots'][
            'ticket_id'] + " please your your case id and try again."
    else:
        response_string = 'We have found your support case. The status is ' + record[
            'Status'] + ' and was last updated ' + time.strftime('%Y-%m-%d %H:%M:%S',
                                                                 time.localtime(float(record['LastUpdatedDate'])))
